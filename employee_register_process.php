    ...
    if(!empty($_POST)){
     ...
     // die();
        ...
        // if($response){
          ...
          $query = "INSERT INTO `tbl_job_applications` (`first_name`,`last_name`,`email`,`date_filled`,`signature_path`,`has_agreement_job`) VALUES ('".$first_name."','".$last_name."','".$email."','".$date_filled."','".$signature_path."','true')";
          // echo $query;die();
         ...
         // save_pdf($html,$mySignature,"signatures/".$file_name2,"signatures/".$file_name3,$file_name_pdf,$pdf_consent_file,$post);
          ...
          // if($send_mail){
            header("Location: employee_sign.php?s=1");exit;
