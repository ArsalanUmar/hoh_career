<?php
 ...
 $ref = (!empty($_GET['r']) && isset($_GET['r'])) ? $_GET['r'] : '';
...
<body>
	...
	<div class="container-contact100">
		...
		<?php exit; }?>
			...
			<hr>
			<form class="contact100-form validate-form" method="POST" enctype="multipart/form-data"  action="influenza_update_form_process.php" >
                ...
                <fieldset>
                    ...
                    <?php } else{ ?>
                          ...
                          <div class="wrap-input100 validate-input row" data-validate="Consent">
                            ...
                            <span class="label-input100 col-md-12" style="text-align:justify;">I understand that due to my occupational exposure to respiratory illnesses, I may be at risk of acquiring Influenza infection. I have been given the opportunity to be vaccinated with the influenza vaccine, at no charge to me. I am aware that I cannot get the influenza disease from the influenza vaccine. I can be infected by the influenza virus but not feel ill for 24-48 hours before symptoms appear, and I can pass the virus to vulnerable patients who are at risk of complications or death from influenza. I can also pass the virus to my family, friends and co-workers. Influenza strains change every year and an immunization received in prior years does not usually provide immunity to this year’s strain of influenza.</span>
                        <span class="focus-input100 col-md-2"></span>
                      </div>
                    </div>
              ...
              <div class="col-md-6 consent_class">
                <div class="wrap-input100 validate-input" data-validate="Date Signed is required">
                  <span class="label-input100">Update Date Signed:</span>
                  <input class="input100" type="date" name="date_signed" placeholder="Enter Date Signed" >
                  <span class="focus-input100"></span>
                </div>
              </div>
					...
					<div class="row">
						<div class="col-md-12">
              <input type="hidden" name="ref" value="<?=$_GET['r']?>">
