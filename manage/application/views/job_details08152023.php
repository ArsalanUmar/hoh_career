          ...
          <div class="col-md-7">
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="col-md-12">
                        ...
                        <dl class="row">
                           <dt class="col-sm-4  mt-2">Name:</dt>
                            ...
                            <dd class="col-sm-8  mt-2"><?=date('F d, Y',strtotime($details->date_of_birth)) ?></dd>
                  ...
                  <div class="col-md-12">
                    <a class="btn  btn-info" href="<?=base_url().'../'.$details->pdf_file_path?>" style=" max-width: 280px!important;
    margin: 0 auto;
