...
class Users extends CI_Controller {
	...
	public function  send_agreement_form(){
		...
		if(!empty($details)){
			...
			$message .= "<p>This email contains a link which will redirect you to the employment agreement and orientation page. Please click this   <a href='".$unique_link."'>link</a> to view and complete.</p>";
...

	{
		...
		$mail->Body = $message;
	    $mail->setFrom('noreply@zedocs.com', 'ZEdocs');
