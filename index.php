                		...
                		<div class="row">
	                	 <div class="col-md-12">
			                <div class="wrap-input100 validate-input" data-validate="Position is required">
                                    ...
                                    <option class="both_jb" value="" style="">Select position applying for</option>
                                    <option class="both_jb" value="Administrator" style="">Executive Director-Administrator</option>
                                    <option class="both_jb" value="Clinical Supervisor/Nursing Supervisor" style="">Clinical Supervisor/Nursing Supervisor</option>
                                    <option class="both_jb" value="Clinical Director/Director of Patient Care Services" style="">Clinical Director/Director of Patient Care Services</option>
                                    <option class="hm_jb" value="Home Health Aide" style="">Home Health Aide</option>
                                    <option class="hm_jb" value="Human Resources" style="">Human Resources</option>
                                    <option class="both_jb" value="Licensed Vocational Nurse" style="">Licensed Vocational Nurse</option>
                                    <option class="both_jb" value="Office Manager" style="">Office Manager</option>
                                    <option class="both_jb" value="Registered Nurse" style="">Registered Nurse</option>
                                    <option class="both_jb" value="Secretary/Receptionist" style="">Secretary/Receptionist</option>
                                </select>
				...
				<!-- 
				 ...
				 <fieldset>
				 	<div class="form-card">
                		...
                		<div class="row">
							<div class="col-md-6">
								<input class="input100" style="width: 90%;
    margin-left: 15px;" type="text" name="recaptcha" placeholder="Enter Captcha image" required>

                        	</div>
                        	<div class="col-md-6">
                        		 <img src="captcha.php?rand=" id='captcha_image'>
                           		 <p>Can't read the image? <a href='javascript: refreshCaptcha();' style="color:blue;">click here</a> to refresh</p>
