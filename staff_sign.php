...
<head>
	...
	<title>Staff Digital Signature Form</title>
...
<body>
	...
	<div class="container-contact100">
		...
		<?php exit; }?>
			...
			<hr>
			<form class="contact100-form validate-form" method="POST" enctype="multipart/form-data"  action="staff_register_process.php" >
