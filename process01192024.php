    ...
    if(strlen($mySignature2) > strlen($mySignature) ){
     ...
     if(strlen($mySignature3) > strlen($mySignature2) ){
      $placed_signature = $mySignature3;
        ...
        $response = base64_to_jpeg($mySignature2,$file_name2);
