...
use PHPMailer\PHPMailer\SMTP;
  ...
  use \setasign\Fpdi\Fpdi;
    ...
    if(!empty($_POST)){
      ...
      $emp_id = NULL;
      $staff_id = NULL;
      // One certificate form posts every section; use elseif so only the clicked test sets staff/employee.
      if (isset($post['submit_waive']) && !empty($post['waived_employee_name'])) {
        $waived_test = true;
        $test_type = "waive";
        $emp_id = $post['waived_employee_name'];
        $staff_id = isset($post['waived_staff_name']) ? trim($post['waived_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['waived_date_filled'];
      } elseif (isset($post['submit_hepab']) && !empty($post['hepab_employee_name'])) {
        $hepab_test = true;
        $test_type = "hepab";
        $emp_id = $post['hepab_employee_name'];
        $staff_id = isset($post['hepab_staff_name']) ? trim($post['hepab_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['hepab_date_filled'];
      } elseif (isset($post['submit_harass']) && !empty($post['harass_employee_name'])) {
        $harass_test = true;
        $test_type = "harass";
        $emp_id = $post['harass_employee_name'];
        $staff_id = isset($post['harass_staff_name']) ? trim($post['harass_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['harass_date_filled'];
      } elseif (isset($post['submit_hh']) && !empty($post['handhygiene_employee_name'])) {
        $handhygiene_test = true;
        $test_type = "handhygiene";
        $emp_id = $post['handhygiene_employee_name'];
        $staff_id = isset($post['handhygiene_staff_name']) ? trim($post['handhygiene_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['handhygiene_date_filled'];
      } elseif (isset($post['submit_emerg']) && !empty($post['emergency_employee_name'])) {
        $emergency_test = true;
        $test_type = "emergency";
        $emp_id = $post['emergency_employee_name'];
        $staff_id = isset($post['emergency_staff_name']) ? trim($post['emergency_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['emergency_date_filled'];
      } elseif (isset($post['submit_covid']) && !empty($post['covid_employee_name'])) {
        $covid_test = true;
        $test_type = "covid";
        $emp_id = $post['covid_employee_name'];
        $staff_id = isset($post['covid_staff_name']) ? trim($post['covid_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['covid_date_filled'];
      } elseif (isset($post['submit_bp']) && !empty($post['bloodpatho_employee_name'])) {
        $bloodpatho_test = true;
        $test_type = "bp";
        $emp_id = $post['bloodpatho_employee_name'];
        $staff_id = isset($post['bloodpatho_staff_name']) ? trim($post['bloodpatho_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['bloodpatho_date_filled'];
      } elseif (isset($post['submit_gluco']) && !empty($post['gluco_employee_name'])) {
        $gluco_test = true;
        $test_type = "gluco";
        $emp_id = $post['gluco_employee_name'];
        $staff_id = isset($post['gluco_staff_name']) ? trim($post['gluco_staff_name']) : '';
        $post['date_filled'] = $_POST['date_filled'] = $post['gluco_date_filled'];
      }

      if ($test_type === '' || empty($emp_id) || $staff_id === '') {
      ...
      $result_logged = $conn->query($sql);
       ...
       if (empty($staff_details)) {
        ...
        // Keep resolved staff on the certificate even after extract() below.
        ...
        if(!empty($employee_test_exists)){
          if($test_type == 'waive'){
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             $query = "UPDATE `tbl_test_certificates` SET `waived_test_file_path` = '".$pdf_test_file_path."', `waived_certificate_file_path` = '".$certificate_file_path."',`waived_test_date`='".$waived_date_filled."',`waived_test_score`='".$waive_score."',`waived_staff_id`='".$waived_staff_name."',`waived_num_hour`='".$waived_num_hour."',`waived_q_1`='".$wave_q1."',`waived_q_2`='".$wave_q2."',`waived_q_3`='".$wave_q3."',`waived_q_4`='".$wave_q4."',`waived_q_5`='".$wave_q5."',`waived_q_6`='".$wave_q6."',`waived_q_7`='".$wave_q7."',`waived_q_8`='".$wave_q8."',`waived_q_9`='".$wave_q9."',`waived_q_10`='".$wave_q10."',`position`='".$waived_position."'  WHERE employee_id='".$waived_employee_name."'";
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             $query = "UPDATE `tbl_test_certificates` SET `hepa_test_file_path` = '".$pdf_test_file_path."', `hepa_certificate_file_path` = '".$certificate_file_path."',`hepa_test_date`='".$hepab_date_filled."',`hepa_test_score`='".$hepab_score."',`hepa_staff_id`='".$hepab_staff_name."',`hepa_num_hour`='".$hepa_num_hour."',`hepa_q_1`='".$hepab_q1."',`hepa_q_2`='".$hepab_q2."',`hepa_q_3`='".$hepab_q3."',`hepa_q_4`='".$hepab_q4."',`hepa_q_5`='".$hepab_q5."',`hepa_q_6`='".$hepab_q6."',`hepa_q_7`='".$hepab_q7."',`hepa_q_8`='".$hepab_q8."',`hepa_q_9`='".$hepab_q9."',`hepa_q_10`='".$hepab_q10."',`hepa_q_11`='".$hepab_q11."' WHERE employee_id='".$hepab_employee_name."'";
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             $query = "UPDATE `tbl_test_certificates` SET `harass_test_file_path` = '".$pdf_test_file_path."', `harass_certificate_file_path` = '".$certificate_file_path."',`harass_test_date`='".$hepab_date_filled."',`harass_test_score`='".$harass_score."',`harass_staff_id`='".$harass_staff_name."',`harass_num_hour`='".$harass_num_hour."',`harass_q_1`='".$harass_q1."',`harass_q_2`='".$harass_q2."',`harass_q_3`='".$harass_q3."',`harass_q_4`='".$harass_q4."',`harass_q_5`='".$harass_q5."',`harass_q_6`='".$harass_q6."',`harass_q_7`='".$harass_q7."',`harass_q_8`='".$harass_q8."',`harass_q_9`='".$harass_q9."',`harass_q_10`='".$harass_q10."',`harass_q_11`='".$harass_q11."',`harass_q_12`='".$harass_q12."',`harass_q_13`='".$harass_q13."',`harass_q_14`='".$harass_q14."' WHERE employee_id='".$harass_employee_name."'";
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             $query = "UPDATE `tbl_test_certificates` SET `hygiene_test_file_path` = '".$pdf_test_file_path."', `hygiene_certificate_file_path` = '".$certificate_file_path."',`hygiene_test_date`='".$handhygiene_date_filled."',`hygiene_test_score`='".$handhygiene_score."',`hygiene_staff_id`='".$handhygiene_staff_name."',`hh_num_hour`='".$hh_num_hour."',`hygiene_q_1`='".$hh_q1."',`hygiene_q_2`='".$hh_q2."',`hygiene_q_3`='".$hh_q3."',`hygiene_q_4`='".$hh_q4."',`hygiene_q_5`='".$hh_q5."',`hygiene_q_6`='".$hh_q6."',`hygiene_q_7`='".$hh_q7."' WHERE employee_id='".$handhygiene_employee_name."'";
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             $query = "UPDATE `tbl_test_certificates` SET `emergency_test_file_path` = '".$pdf_test_file_path."', `emergency_certificate_file_path` = '".$certificate_file_path."',`emergency_test_date`='".$emergency_date_filled."',`emergency_test_score`='".$emergency_score."',`emergency_staff_id`='".$emergency_staff_name."',`emerg_num_hour`='".$emerg_num_hour."',`emergency_q_1`='".$emerg_q1."',`emergency_q_2`='".$emerg_q2."',`emergency_q_3`='".$emerg_q3."',`emergency_q_4`='".$emerg_q4."',`emergency_q_5`='".$emerg_q5."',`emergency_q_6`='".$emerg_q6."' WHERE employee_id='".$emergency_employee_name."'";
           }elseif($test_type == 'bp'){
          ...
          if($test_type == 'waive'){
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             $query = "INSERT INTO `tbl_test_certificates` (`employee_id`,`position`,`waived_test_file_path`,`waived_certificate_file_path`,`waived_test_date`,`waived_test_score`,`waived_staff_id`,`waived_num_hour`,`waived_q_1`,`waived_q_2`,`waived_q_3`,`waived_q_4`,`waived_q_5`,`waived_q_6`,`waived_q_7`,`waived_q_8`,`waived_q_9`,`waived_q_10`) VALUES ('".$waived_employee_name."','".$waived_position."','".$pdf_test_file_path."','".$certificate_file_path."','".$waived_date_filled."','".$waive_score."','".$waived_staff_name."','".$waived_num_hour."','".$wave_q1."','".$wave_q2."','".$wave_q3."','".$wave_q4."','".$wave_q5."','".$wave_q6."','".$wave_q7."','".$wave_q8."','".$wave_q9."','".$wave_q10."')";
          }elseif($test_type == 'hepab'){
             $employee_id = $harass_employee_name;
            // echo "ad";die();
            $harass_score = 0;
            $n_items = 11;
             ...
             $query = "INSERT INTO `tbl_test_certificates` (`employee_id`,`hepa_test_file_path`,`hepa_certificate_file_path`,`hepa_test_date`,`hepa_test_score`,`hepa_staff_id`,`hepa_num_hour`,`hepa_q_1`,`hepa_q_2`,`hepa_q_3`,`hepa_q_4`,`hepa_q_5`,`hepa_q_6`,`hepa_q_7`,`hepa_q_8`,`hepa_q_9`,`hepa_q_10`,`hepa_q_11`) VALUES ('".$hepab_employee_name."','".$pdf_test_file_path."','".$certificate_file_path."','".$hepab_date_filled."','".$hepab_score."','".$hepab_staff_name."','".$hepa_num_hour."','".$hepab_q1."','".$hepab_q2."','".$hepab_q3."','".$hepab_q4."','".$hepab_q5."','".$hepab_q6."','".$hepab_q7."','".$hepab_q8."','".$hepab_q9."','".$hepab_q10."','".$hepab_q11."')";
          }
        elseif($test_type == 'harass'){
             $employee_id = $harass_employee_name;
            // echo "ad";die();
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             $query = "INSERT INTO `tbl_test_certificates` (`employee_id`,`harass_test_file_path`,`harass_certificate_file_path`,`harass_test_date`,`harass_test_score`,`harass_staff_id`,`harass_num_hour`,`harass_q_1`,`harass_q_2`,`harass_q_3`,`harass_q_4`,`harass_q_5`,`harass_q_6`,`harass_q_7`,`harass_q_8`,`harass_q_9`,`harass_q_10`,`harass_q_11`,`harass_q_12`,`harass_q_13`,`harass_q_14`) VALUES ('".$harass_employee_name."','".$pdf_test_file_path."','".$certificate_file_path."','".$harass_date_filled."','".$harass_score."','".$harass_staff_name."','".$harass_num_hour."','".$harass_q1."','".$harass_q2."','".$harass_q3."','".$harass_q4."','".$harass_q5."','".$harass_q6."','".$harass_q7."','".$harass_q8."','".$harass_q9."','".$harass_q10."','".$harass_q11."','".$harass_q12."','".$harass_q13."','".$harass_q14."')";
          }elseif($test_type == 'handhygiene'){
            $employee_id = $handhygiene_employee_name;
            // echo "ad";die();
            $handhygiene_score = 0;
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             if($test_pass){
              ...
              $query = "INSERT INTO `tbl_test_certificates` (`employee_id`,`hygiene_test_file_path`,`hygiene_certificate_file_path`,`hygiene_test_date`,`hygiene_test_score`,`hygiene_staff_id`,`hh_num_hour`,`hygiene_q_1`,`hygiene_q_2`,`hygiene_q_3`,`hygiene_q_4`,`hygiene_q_5`,`hygiene_q_6`,`hygiene_q_7`) VALUES ('".$employee_id."','".$pdf_test_file_path."','".$certificate_file_path."','".$handhygiene_date_filled."','".$handhygiene_score."','".$handhygiene_staff_name."','".$hh_num_hour."','".$hh_q1."','".$hh_q2."','".$hh_q3."','".$hh_q4."','".$hh_q5."','".$hh_q6."','".$hh_q7."')";
            ...
            $query = "INSERT INTO `tbl_test_certificates` (`employee_id`,`covid_test_file_path`,`covid_certificate_file_path`,`covid_test_date`,`covid_test_score`,`covid_staff_id`,`covid_num_hour`,`covid_q_1`,`covid_q_2`,`covid_q_3`,`covid_q_4`,`covid_q_5`,`covid_q_6`,`covid_q_7`) VALUES ('".$employee_id."','".$pdf_test_file_path."','".$certificate_file_path."','".$covid_date_filled."','".$covid_score."','".$covid_staff_name."','".$covid_num_hour."','".$covid_q1."','".$covid_q2."','".$covid_q3."','".$covid_q4."','".$covid_q5."','".$covid_q6."','".$covid_q7."')";
            ...
            for($x=1;$x<=$n_items;$x++){
             ...
             if($test_pass){
               ...
               $query = "INSERT INTO `tbl_test_certificates` (`employee_id`,`bloodpatho_test_file_path`,`bloodpatho_certificate_file_path`,`bloodpatho_test_date`,`bloodpatho_test_score`,`bloodpatho_staff_id`,`patho_num_hour`,`bloodpatho_q_1`,`bloodpatho_q_2`,`bloodpatho_q_3`,`bloodpatho_q_4`,`bloodpatho_q_5`,`bloodpatho_q_6`,`bloodpatho_q_7`,`bloodpatho_q_8`,`bloodpatho_q_9`,`bloodpatho_q_10`,`bloodpatho_q_11`,`bloodpatho_q_12`,`bloodpatho_q_13`,`bloodpatho_q_14`,`bloodpatho_q_15`,`bloodpatho_q_16`,`bloodpatho_q_17`,`bloodpatho_q_18`,`bloodpatho_q_19`,`bloodpatho_q_20`) VALUES ('".$employee_id."','".$pdf_test_file_path."','".$certificate_file_path."','".$bloodpatho_date_filled."','".$bloodpatho_score."','".$bloodpatho_staff_name."','".$patho_num_hour."','".$bp_q1."','".$bp_q2."','".$bp_q3."','".$bp_q4."','".$bp_q5."','".$bp_q6."','".$bp_q7."','".$bp_q8."','".$bp_q9."','".$bp_q10."','".$bp_q11."','".$bp_q12."','".$bp_q13."','".$bp_q14."','".$bp_q15."','".$bp_q16."','".$bp_q17."','".$bp_q18."','".$bp_q19."','".$bp_q20."')";
    ...
    // echo $pdf_consent_file;die();
        ...
        if($test_pass){
         ...
         $pdf->SetXY(70 ,143);  
           ...
           // $staff_signature = "signatures/test2.jpg";
           // $size = getimagesize($staff_signature);
