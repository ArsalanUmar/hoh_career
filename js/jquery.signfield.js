    ...
    $.fn.signField = function(arg) {
        ...
        fields.each(function(i,x) {
            ...
            if (canvas) {
                ...
                hf = $('<input type="hidden" class="imgdata" name="'+n+'" value="" />').
                    appendTo(div),
                dc = canvas.get(0),
                ...
                $('<button onclick="clear_canvas(\''+id+'\')" ref="'+id+'" class="btn btn-warning">' +
                  i18n('sketch.clear') + ' <i class="fa fa-eraser"></i></button>').insertBefore(canvas).
                    click(function(){
