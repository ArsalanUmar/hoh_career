...
$(".next").click(function(){
    ...
    if(current_fs_index == '1'){
        // $('form').submit();
        // var no_question =10;
      if($('fieldset#waived_test').find('.alert-validate').length > 0 ||  $('fieldset#waived_test').find('input.show_radio:checked').length !=no_question){
          swal({
                            title: "Oops!",
                            text: "Please complete the waive test to proceed.",
                            icon: "warning"
                          });
      ...
      // $('form').submit();
       // var no_question =11;
      if($('fieldset.hepa_b').find('.alert-validate').length > 0 ||  $('fieldset.hepa_b').find('input.show_radio:checked').length !=no_question){
          swal({
                            title: "Oops!",
                            text: "Please complete the hepatitis b test to proceed.",
                            icon: "warning"
                          });
        ...
        // $('form').submit();
         // var no_question =14;
        if($('fieldset.harass').find('.alert-validate').length > 0 ||  $('fieldset.harass').find('input.show_radio:checked').length !=no_question){
            swal({
                              title: "Oops!",
                              text: "Please complete the harassment test to proceed.",
                              icon: "warning"
                            });
           ...
           // $('form').submit();
         // var no_question =7;
        if($('fieldset.handhygiene').find('.alert-validate').length > 0 ||  $('fieldset.handhygiene').find('input.show_radio:checked').length !=no_question){
            swal({
                              title: "Oops!",
                              text: "Please complete the hand hygiene test to proceed.",
                              icon: "warning"
                            });
    ...
    }else if(current_fs_index == '5'){
           // $('form').submit();
         // var no_question =6;
        if($('fieldset.emergency').find('.alert-validate').length > 0 ||  $('fieldset.emergency').find('input.show_radio:checked').length !=no_question){
            swal({
                              title: "Oops!",
                              text: "Please complete the emergency test to proceed.",
                              icon: "warning"
                            });
    ...
    }else if(current_fs_index == '6'){
           // $('form').submit();
         // var no_question =7;
        if($('fieldset.covid').find('.alert-validate').length > 0 ||  $('fieldset.covid').find('input.show_radio:checked').length !=no_question){
            swal({
                              title: "Oops!",
                              text: "Please complete the COVID test to proceed.",
                              icon: "warning"
                            });
    ...
    }else if(current_fs_index == '7'){
           // $('form').submit();
         // var no_question =20;
        if($('fieldset.bloodpatho').find('.alert-validate').length > 0 ||  $('fieldset.bloodpatho').find('input.show_radio:checked').length !=no_question){
            swal({
                              title: "Oops!",
                              text: "Please complete the blood pathogen test to proceed.",
                              icon: "warning"
                            });
    ...
    }else if(current_fs_index == '8'){
           // $('form').submit();
         // var no_question =17;
        if($('fieldset.glucometer').find('.alert-validate').length > 0 ||  $('fieldset.glucometer').find('input.show_radio:checked').length !=no_question){
            swal({
                              title: "Oops!",
                              text: "Please complete the glucometer test to proceed.",
                              icon: "warning"
                            });
