...
// Check if the field is a date input
   var dateFields = ['date_of_birth', 'date_filled', 'dl_expiration', 'work_date_from_2', 'work_date_to_2', 'work_date_from_3', 'work_date_to_3', 'work_date_from_1', 'work_date_to_1'];

   // Check if the field's name is one of the date fields
   if (dateFields.includes(name_attr)) {
     val_attr = formatDate(val_attr); // Format the date
   }
...
function formatDate(inputDate) {
  // Validate inputDate to ensure it's a valid date
  ...
  return inputDate; // Return the original value if invalid
}
