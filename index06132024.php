 ...
 <script>
  $(document).ready(function(){
          ...
          $('select[name="company_applying"]').on('change',function(){
            ...
            if(val == 'Hospice'){
              $('select[name="position"]').find('option.hospice_jb,option.both_jb').show();//.css('display','show');
               $('select[name="position"]').find('option.hm_jb,option.bothh_jb').hide();//.css('display','block');

                $('select[name="position"]').find('option.hospice_jb,option.both_jb').removeAttr('disabled');
                $('select[name="position"]').find('option.hm_jb,option.bothh_jb').attr('disabled','disabled');
            }
            if(val == 'Home Health' ){
              $('select[name="position"]').find('option.hospice_jb,option.bothh_jb').hide();
               ...
               $('select[name="position"]').find('option.hospice_jb,option.bothh_jb').attr('disabled','disabled');
                 $('select[name="position"]').find('option.hm_jb,option.both_jb').removeAttr('disabled');
            }
            ...
            if( val== 'Both'){
                    ...
                    $('select[name="position"]').find('option.hospice_jb,option.hm_jb').attr('disabled','disabled');
                     $('select[name="position"]').find('option.both_jb,option.bothh_jb').removeAttr('disabled');
            }
          });
        });
    </script>
