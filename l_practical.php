...
<head>
    ...
    <title>Performance Evaluation - Licensed Practical/Vocational Nurse</title>
    <style>
        /* ===== 4TH CODE PATTERN ===== */
        @media print {
...
<body>
    ...
    <div class="page">
        ...
        <div class="header" style="position:relative;">
            <label style="font-weight:bold;">Job Title/Position:</label> <i>Licensed Practical/Vocational Nurse</i> <br>
        ...
        <table>
            <tr>
                <th style="width:80%; text-align: left;">A. Patient Care Responsibilities</th>
                <th style="width:20%;">Rating</th>
            </tr>

            <tr>
                <td class="text-col">1. Provides direct patient care as defined in State Nurse Practice Act.</td>
            ...
            <tr>
                <td class="text-col">2. Implements plan of care initiated by the registered nurse.</td>
            ...
            <tr>
                <td class="text-col">3. Provides accurate and timely documentation consistent with the plan of care.</td>
            ...
            <tr>
                <td class="text-col">4. Assesses and provides patient and family/caregiver education and information pertinent to diagnosis and plan of care.</td>
            ...
            <tr>
                <td class="text-col">5. Participates in coordination of home health services, appropriately reporting the identified needs for other disciplines (HHA, OT, PT, MSW, ST, Dietician) to the registered nurse and/or Clinical Supervisor/Nursing Supervisor.</td>
            ...
            <tr>
                <td class="text-col">6. Uses equipment and supplies effectively and efficiently.</td>
            ...
            <tr>
                <td class="text-col">7. Participates in personal, professional growth and development.</td>
            ...
            <tr>
                <td class="text-col">8. Performs other duties as assigned by the RN.</td>
    ...
    <div class="page">
        ...
        <!-- Header -->
        <div class="header">
            <label style="font-weight:bold;">Job Title/Position:</label> <i>Licensed Practical/Vocational Nurse</i> <br><br>
        ...
        <table>
            ...
            <tr>
                <td class="text-col">3. Maintains an acceptable work record.<br><br>
            ...
            <tr>
                ...
                <td class="rating-col">1<input type="radio" name="org9"> 2<input type="radio" name="org9"> 3<input type="radio" name="org9"> 4<input type="radio" name="org9"></td>
            </tr>

            <tr>
                <td class="text-col">10. Participates in organization quality activities to improve organizational performance.</td>
                <td class="rating-col">1<input type="radio" name="org10"> 2<input type="radio" name="org10"> 3<input type="radio" name="org10"> 4<input type="radio" name="org10"></td>
            </tr>

            <tr>
                <td class="text-col">11. Interacts collaboratively with all team members.</td>
                <td class="rating-col">1<input type="radio" name="org11"> 2<input type="radio" name="org11"> 3<input type="radio" name="org11"> 4<input type="radio" name="org11"></td>
            </tr>
        </table>
    ...
    <div class="page">
        ...
        <div class="header">
            <label>Job Title/Position:</label> <i>Licensed Practical/Vocational Nurse</i> <br><br>
