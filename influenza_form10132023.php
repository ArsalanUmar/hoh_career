		...
		<?php exit; }?>
			...
			<form class="contact100-form validate-form" method="POST" enctype="multipart/form-data"  action="influenza_form_process.php" >
                ...
                <fieldset>
                 ...
                 <div class="col-md-6 ">
                <div class="wrap-input100 validate-input" data-validate="Consent">
                ...
                <div class="wrap-input100 validate-input" data-validate="Decline Reason is required"> 
                  ...
                  <select class="select100" type="text" name="decline_reason" placeholder="Reason"  style="max-width:370px;">
                      <option>Select a reason</option>
                      <option value="opt_1">I have already received influenza vaccine and have provided documentation</option>
