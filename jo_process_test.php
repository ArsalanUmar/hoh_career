...
use PHPMailer\PHPMailer\SMTP;
  ...
  use \setasign\Fpdi\Fpdi;
    ...
    if(!empty($_POST)){
      ...
      $organization = $_POST['company_applying'];
        $position = $_POST['position'];//$record_details['position'];
        $post['organization'] =  $_POST['company_applying'];
        $jo_pdf_file = $jo_pdf_file_2 = "";
...
// echo $jo_pdf_file;die();
  ...
  $pdf_jo_file_name_2 = "";
       ...
       $pdf_agr_file_name = "pdf_files/AGR_".$file_name_pdf.' '.date('Y-m-d').'.pdf';
        ...
        $response3 = base64_to_jpeg($mySignature,$file_name3);
        ...
        if($response){
          ...
          $data2= explode(",", $mySignature);

          $query = "UPDATE `tbl_job_applications` SET organization='".$organization."',position='".$position."','".$organization."',has_agreement_job='true',jo_file_path='pdf_files/".$pdf_jo_file_name."',jo_agreement_file_path='".$pdf_agr_file_name."' WHERE id='".$ref."'";
         ...
         save_pdf($html,$mySignature, $mySignature, $mySignature,$pdf_jo_file_name,$pdf_jo_file_name_2,$pdf_agr_file_name,$jo_pdf_file,$jo_pdf_file_2,$file_name_pdf,$file_name_pdf_2,$post);

          // send_mail($file_name,"flippincrazyllc@yahoo.com",$name,$date,$_POST);

         // echo $pdf_jo_file_name;die();
// echo $pdf_jo_file_name_2;die();
          $send_mail =send_mail($file_name,$email,$name,$date,$post,false,$pdf_jo_file_name,$pdf_jo_file_name_2,$pdf_agr_file_name,$file_name_pdf,$file_name_pdf_2);
  ...
  function send_mail($file_name,$email,$name,$date,$post=array(),$receiver=false,$pdf_file1="",$pdf_jo_file_name_2="",$pdf_file2="",$file_name_pdf="",$file_name_pdf_2=""){
...
// die();
      ...
      // fclose($handle);
        ...
        if($receiver){
          ...
          $subject = "JOB AGREEMENT - New  form has been received.";
...
// echo $pdf_file2;die();
  ...
  function save_pdf($html,$signature1,$signature2,$signature3,$name="",$pdf_jo_file_name_2="",$agr_name="",$jo_pdf_file="",$jo_pdf_file_2="",$ack_pdf_file="",$ack_2_pdf_file="",$post=array()){
// echo "adsa";die();
    // echo $name;die();
// echo $name ." ".$pdf_jo_file_name_2;die();
...
// echo $pdf_file_name;die();
      ...
      if(!empty($jo_pdf_file_2)){
// echo $jo_pdf_file_2." ".$pdf_jo_file_name_2;die();
            $pdf = new FPDI();  
...
// echo $agr_name;die();
    ...
    if($post['organization'] == 'Both'){
       ...
       $pdf->Image($placed_signature,50,190,60,20,"PNG");
