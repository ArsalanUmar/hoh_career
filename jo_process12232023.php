     ...
     // die();
       ...
       $pdf_agr_file_name = "pdf_files/AGR_".$file_name_pdf.' '.date('Y-m-d').'.pdf';
        ...
        $file_name_pdf_2 = $file_name_pdf_3 = NULL;
         ...
         save_pdf($html,$mySignature, $mySignature, $mySignature,$pdf_jo_file_name,$pdf_jo_file_name_2 ,$pdf_jo_file_name_3, $pdf_jo_file_name_4,$pdf_agr_file_name,$jo_pdf_file,$jo_pdf_file_2,$jo_pdf_file_3,$jo_pdf_file_4,$file_name_pdf,$file_name_pdf_2,$file_name_pdf_3,$post);
