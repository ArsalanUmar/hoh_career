  ...
  use \setasign\Fpdi\Fpdi;
    ...
    if(!empty($_POST)){
     ...
     // die();
        ...
        header("Location: index.php?s=" . $encoded_id);
        exit();
    } else {
