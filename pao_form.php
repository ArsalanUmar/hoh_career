	...
	<div class="container-contact100">
		...
		<?php }?>
			<div class="contact100-form-title-2">
					...
					&nbsp;&nbsp;PERSONNEL ACKNOWLEDGEMENT OF ORIENTATION
			</div>

			<hr>

			<form class="contact100-form validate-form" method="POST" enctype="multipart/form-data"  action="pao_process.php" >
                ...
                <fieldset>
                	<div class="eval_class form-card">
	                	...
	                	<!-- 	<div class="row">
	                		...
	                		<div class="row mt-3">
	                				<div class="col-md-12">
	                					<p>By signing the pad you have agreed in the following document:</p>
	                				</div>
	                		</div>
	                		<div class="row mt-3">
	                			<div class="col-md-12">
